...
var valoo = _interopDefault(require('valoo'));
...
function filterResultsFactory(store) {
    var Results = function (props) {
        var _a = React.useState(""), searchVal = _a[0], setSearch = _a[1];
        ...
        var prefilterItems = function (s) {
            ...
            (props.prefilters || []).forEach(function (_a) {
                var regex = _a.regex, handler = _a.handler;
            ...
            return { items: items, search: s };
        };
        var filterItems = function (s) {
            var _a = prefilterItems(s || ""), items = _a.items, search = _a.search;
            if (search.trim() === "") {
        ...
        return React__default.createElement(React.Fragment, null, props.children(filteredItems));
    };
...
function inputFilterFactory(store) {
    ...
    var Input = function (props) {
        ...
        var _a = React.useState(initialSearch), inputValue = _a[0], setValue = _a[1];
        var debouncedUpdate = React.useCallback(debounce(updateValue, debounceTime), [
            debounceTime,
        ]);
        React.useEffect(function () {
            var unsubscribe = store.on(function (_a) {
        ...
        return (React__default.createElement("input", tslib_1.__assign({ className: props.classPrefix + "__input", onChange: handleChange, value: inputValue }, props.inputProps)));
    };
...
module.exports = fuzzyFilterFactory;
//# sourceMappingURL=react-fuzzy-filter.cjs.development.js.map
