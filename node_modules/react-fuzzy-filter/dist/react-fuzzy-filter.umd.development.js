(function (global, factory) {
    ...
    (global = global || self, factory(global.ReactFuzzyFilter = {}, global.React));
}(this, function (exports, React) { 'use strict';

    var React__default = 'default' in React ? React['default'] : React;

    function valoo(n){var t=[];function u(u){return arguments.length&&t.map(function(t){t&&t(n=u);}),n}return u.on=function(n){var u=t.push(n)-1;return function(){t[u]=0;}},u}
    ...
    ***************************************************************************** */
    ...
    function inputFilterFactory(store) {
      ...
      var Input = function (props) {
        ...
        var _a = React.useState(initialSearch),
            inputValue = _a[0],
            setValue = _a[1];

        var debouncedUpdate = React.useCallback(debounce_1(updateValue, debounceTime), [debounceTime]);
        React.useEffect(function () {
          var unsubscribe = store.on(function (_a) {
            var v = _a.v,
                t = _a.t;
    ...
    exports.default = fuzzyFilterFactory;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=react-fuzzy-filter.umd.development.js.map
